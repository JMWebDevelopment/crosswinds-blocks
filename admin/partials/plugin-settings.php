...
$blocks = array(
	...
	'project-category-search' => array(
		'slug'        => 'project-category-search',
		'name'        => esc_html__( 'Project Category Search', 'crosswinds-blocks' ),
		'description' => esc_html__( 'Creates a section to search by project category.', 'crosswinds-blocks' ),
		'documentation_link' => '',
	...
	'project-search' => array(
		'slug'        => 'project-search',
		'name'        => esc_html__( 'Project Search', 'crosswinds-blocks' ),
		'description' => esc_html__( 'Add in a block to allow a user to search project items.', 'crosswinds-blocks' ),
		'documentation_link' => '',
		'icon'        => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#1b1930" class="fa-primary" d="M500.3 443.7l-119.7-119.7c-15.03 22.3-34.26 41.54-56.57 56.57l119.7 119.7c15.62 15.62 40.95 15.62 56.57 0C515.9 484.7 515.9 459.3 500.3 443.7z"/><path fill="#3e7ea8" class="fa-secondary" d="M207.1 0C93.12 0-.0002 93.13-.0002 208S93.12 416 207.1 416s208-93.13 208-208S322.9 0 207.1 0zM207.1 336c-70.58 0-128-57.42-128-128c0-70.58 57.42-128 128-128s128 57.42 128 128C335.1 278.6 278.6 336 207.1 336z"/></svg>',
	),
	'project-tag-search' => array(
		'slug'        => 'project-tag-search',
		'name'        => esc_html__( 'Project Tag Search', 'crosswinds-blocks' ),
		'description' => esc_html__( 'Creates a section to search by project tag.', 'crosswinds-blocks' ),
		'documentation_link' => '',
		'icon'        => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#1b1930" class="fa-primary" d="M500.3 443.7l-119.7-119.7c-15.03 22.3-34.26 41.54-56.57 56.57l119.7 119.7c15.62 15.62 40.95 15.62 56.57 0C515.9 484.7 515.9 459.3 500.3 443.7z"/><path fill="#3e7ea8" class="fa-secondary" d="M207.1 0C93.12 0-.0002 93.13-.0002 208S93.12 416 207.1 416s208-93.13 208-208S322.9 0 207.1 0zM207.1 336c-70.58 0-128-57.42-128-128c0-70.58 57.42-128 128-128s128 57.42 128 128C335.1 278.6 278.6 336 207.1 336z"/></svg>',
	),
