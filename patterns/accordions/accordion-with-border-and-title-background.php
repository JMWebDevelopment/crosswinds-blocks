...
return array(
	...
	'content'       => '<!-- wp:crosswinds-blocks/accordions {"className":"basic-accordion"} -->
						...
						<h3 class="wp-block-heading has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px">' . __( 'This is a heading', 'crosswinds-blocks' ) . '</h3>
