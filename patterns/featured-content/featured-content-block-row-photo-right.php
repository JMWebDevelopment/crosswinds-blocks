...
return array(
	'title'         => esc_html__( 'Featured Content - Row with Right Photo', 'crosswinds-blocks' ),
	'viewportWidth' => 1200,
	...
	<div class="wp-block-group alignwide featured-content-block-row-photo-right"><!-- wp:crosswinds-blocks/single-content {"postId":1,"align":"wide"} -->
	<!-- wp:columns -->
