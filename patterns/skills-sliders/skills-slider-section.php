...
return array(
	...
	'viewportWidth' => 500,
	'content'       => '<!-- wp:group {"className":"skills-slider-section","layout":{"type":"constrained"}} -->
						<div class="wp-block-group skills-slider-section"><!-- wp:columns -->
						...
						<!-- wp:column -->
						<div class="wp-block-column"><!-- wp:group {"className":"skills-sliders-group","layout":{"type":"constrained"}} -->
